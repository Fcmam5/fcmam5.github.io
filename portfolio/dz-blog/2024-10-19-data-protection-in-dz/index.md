...
According to reports and to projects often labeled "[Algeria 2030](https://state-of-algeria.dev/docs/insights/future#algeria-2030)", the government in Algeria is also aiming to diversify the Algerian economy and to promote a more agile e-government, joining efforts with experts to kickstart new technological investment streams.

In a vibrant tech ecosystem, we notice an increasing number of developers and applications overtime. This rapid development is exciting, but it has outpaced essential data privacy and software development and security best practices.
...
Yes, I do have some concerns about this domain in particular as we might not be mature yet when it comes to technology. We are lacking behind in topics related to cyber hygiene and online data privacy cultures. We can do better, and we must.
...
- **Data Privacy** is the right of individuals to control how data is used and shared. It can go from not wanting strangers to know your mother's name, to websites from knowing your real name, birth date, and your gender... **You** have the rights to share and not to share/disclose any sensitive information about yourself.
- **Sensitive information** is data that requires protection, is the data people and organizations want to keep private. They may get harmed if these information are exposed, or handed to the wrong parties.
...
Regulators, the government and other organizations working with them define **users rights**, and create frameworks for companies to operate and deal with users' personal and sensitive information. The Algerian law defines these rights sets up agencies who works on auditing and making sure that companies are compliant with these laws. Among these agencies, we have [ANDPD](https://anpdp.dz/), [ARPCE](https://www.arpce.dz/), etc.
...
Before your roll your eyes disagreeing with the last sentence, [Wait... Let me tell you something..](https://youtu.be/iIl8aFAeX9Q?t=69): It's not going well, and I will tell you why I think that as a user myself, I don't trust the government with this. Therefor, the first link in our diagram is problematic:
...
If the users doesn't trust the regulators (the government in our case), or if they're ignorant about their rights. Companies and developers may get away with a lot. Therefor, we may end up with a weaker trust chain, as the following:
...
I'm not sure if that sounded alarming, or concerning, or if it sounded that I got an unauthorized access to our faculty of medicine...
...
> When I started writing this blog LAST YEAR, I used that example as one of the worst PII-breaches. Then I saw even a more alarming post from the official **Wilaya D'Oran** page.
> 
> ![List of candidates for housing, with more PII](oran-housing-pii.png)
>
> This post itself was funny and scary at the same time, it was funny because it's unbelievable that such an official page posted a list of 200+ persons, with their photos, full names, data and place of birth, father & mother's names and their marital status... Online, publicly, on Facebook.

<br/>

**Victims** of these data exposures are subject to different threats. Threat actors can impersonate them and use their identities in fraudulent actions; Why would a scammer invent a persona for their attacks when they can use a real person's identity (name, birth date and place, etc.).

These victims' reputation might be damaged because of these data breaches, these people's personal lives are exposed online; Why should anyone know that Mr. X is a candidate of social housing in that area, that information may affect their personal lives. People don't need to know that Mme Y was a candidate in a certain admission exam and got selected, or not selected, because Mme Y, may need to secure her plan B and apply for a different job, etc.

People in these lists are **victims** as many things can go wrong with their lives because of these leaked information.

"The culture" is so messed up in Algeria, that even more sensitive industries do such practices "for transparency", while they expose themselves as organizations and candidates/employees to major dangers. For example, I found a **public** document on the Algerian customs website for the list of candidates that were selected to pass admission exams. Threat actors may short-list potential customs employees for doxing them and/or infiltrate administrations.
...
This brings my to the other problematic point, the problem with authorities.
...
On paper, on media, and on multiple online platforms this initiative makes me feel that there is a legal base, there's a political will, and a strong base to start the journey of respecting Algerians' personal and identifiable data.
...
Maybe for once, we can't really blame the government, or at least: Not yet, not for everything. So, why I think they're also a part of the problem?

![Khatinism meme](khatinizm.png)

Because I think that the solution has some of **Khatinizm** (`stay tuned for a next blog about "The art of khatinism"`). The government and its ministries outsourced the responsibility to the ANPDP and other agencies, however, when things gets murky everyone would start pointing fingers at others, and responsibilities may fall in the cracks between different agencies. That may make holding someone accountable difficult.

That might be a bit harsh of a statement, but that what I felt when trying to report incidents, or when trying to get something done.

The previous examples earlier, are far from being the only conflict where Algerians' PII are not respected by government agencies themselves.

For example, some official websites do no mention how our data as users are treated, others even have empty Terms and condition pages, such as [Startup.dz](https://startup.dz/conditions-generales/):

![Startup.dz](empty-tnc.png)

When I wanted to create an account, I was genuinely interested in knowing what information they need from me and how they will process them, but unfortunately, they still have an empty page for several months now ([Wayback machine link](https://web.archive.org/web/20240000000000*/https://startup.dz/conditions-generales/)).

I also found that some official websites use trackers and analytics tools that works even without users' consent.

![GA Loaded in a GOV website](no-cookie-gov.png)

In the example above, I found that [Google Analytics](https://marketingplatform.google.com/about/analytics/) was loaded even before I click on "Confirm button". I thought that this either a bug, or the developer used the wrong word in their cookie consent CTA button. The privacy notes page explicitly say that the website will collect any analytics without user's consent.

I thought that website has a bug or an ignored implementation of a consent button that enabled Google Analytics on a government website. So I geeked for a moment and checked their button's event listener, maybe that something slipped away from the developers or QAs (if they have ones). To my surprise, I found even more alarming things...
...
As an Algerian, I do understand the hype and the rush to digitalize everything and to go online for everything. I also see "Passing the Torch to the youth" initiatives, but I'm a little bit puzzled (to not say disappointed) when I see government and public companies' website not being the model in respecting Algerian regulations.
...
These examples makes me question: Who's auditing, and who can report such incidents to who?

#### The ANPDP and Co

I had a disappointing experiences with ANPDP. I hope I'm wrong, or unlucky or just wrong about them. But let me tell my story:
...
Me, a random person on the internet could found these. And as a developer who happened to check his logs, I know that the web in 2024 is full of bots/crawlers, and of automated scanners who keep scanning for such low hanging fruits.
...
From what I understood that users and organizations are not aware of data protection laws in Algeria, and not aware about the existence of an agency like ANPDP or they don't know what they "can do" exactly. While others choose to ignore and doge the Algerian regulations.
...
When you ask companies, you get answers like: "Yes of course", or we "the the best we can", or more concerning answers like: "What do you mean by data protection? We use SSL/TLS, <nobr>and use \{Insert a framework, Cloud provider or DBMS here\}"</nobr>.

> So, can we tell that Algerian companies actually know and care about data privacy of their employees and customers?

This bit is tricky to answer, we can't talk about different companies in this "already long" article. But let me try to keep it short, and hopefully other experts would dig in this topic further.

For this let's talk about some areas I think are problematic:

#### The culture (again), and training staff

As mentioned earlier, we are very social and community-driven society. If you need a companies' secrets, just sit in cafés where their employees hangout, or if you are a female... I don't know, maybe try to go to meet them at a hairdresser or something.

One of my friends who's also a computer guy told me that some user accounts in town hall systems (la mairie) is `123456`. Yes, first how did he know? Second, seriously **123456**? Who should change it or tell people how/why they must do it?

Being the geek/the computer guy, I always had people asking me to fix their work computer, or their personal computer that happens to have work-related information. As an unauthorized person I could easily get information that I was not supposed to have, or I could install a malicious software (even without me knowing) that would lead to a backdoor to a whole organization.

... I thought I had enough stories until last month, where we needed to open a support ticket to resolve an issue with a large Algerian cloud service provider, our contact person on *the phone* asked for our VM's IP address, during the call we had a misunderstanding so they heard a different number so they said: "Are you calling for [~~AN OFFICIAL CULTURAL BUILDING~~]?" The person just handed us, random people an IP address we were not supposed to know.

Being in the Algerian's social environment, you will have a fair share of information about any organization with a minimum social engineering effort/experience.

<br/>

With an experience from working for a foreign company, we often perform mandatory compliance and cybersecurity trainings. In our day-to-day job, these training are annoying and almost no one of us like them... But when we think about what can go wrong if we forget about eavesdropping and shoulder surfing and that these things may get people and **organizations** in troubles.
...
There were endless of data breaches in Algerian companies and government agencies. But to mention some of the ones I personally saw:
...
The incident was reported by different activists on different social media platform, then days after the "noise". The responsible company published an official statement on their Facebook page:

![Official statement from jobs platform](official-statement-job-platform.png)

The statement only mentioned that the numbers shared on social media are not correct, and that they detected the attack and could stop it. The mentioned they, as all big companies are targeted by cyberattacks.

When I saw the news on social media, I looked up some data breach forums on dark web. Then I searched in that forum for `Algeria` and `DZ`, and unfortunately, I could find more data breaches... Among the most critical ones was A breach that affected CNAS (National Fund for Social insurance for social workers):
...
Notifying victims of data breaches is an ethical and a legal obligation, well maybe; I'm not a lawyer but when reading the following:
...
Therefor, if the ANDP decides that the compromised data was encrypted or that it was not a personal identifiable data, companies are not always required to disclose these data breaches. But, do they do when PII data is compromised?
...
The answers were mostly negative, Algerian engineers and experts in IT field almost had the same answer: `Akhtik(أخطيك)/Khatini(خاطيني)` which means `Stay away from that / I'm staying away from that`. Since there are no clear ways to report issues, and we find a way, we'd be risking a lot if we report them.

I heard stories of people who were interrogated by the police and faced serious problems after they reported vulnerabilities to companies, then these companies reported these people.

Even if a stubborn person like me tries his luck, and wants to report problems, it might not be the easiest... I personally trie to email and call companies, the ANPDP, APOCE and other authorities to report an incident I mentioned earlier. In other cases, I just used my network and tried to find a person who knows a person to get them to fix something.
...
Consumer advocatory groups like [APOCE](https://apoce.org/) can also be used to report such incidents and let them use their networks to get victims' rights and/or compensate them.

We as consumers and users of digital products should know our rights, and know where and how to report companies that doesn't respect our data privacy. And it's on companies, on organizations and companies, on schools and on initiatives like [Salamat](https://portal.salamatmena.org/) to educate us about such things.

<br/>

Back to our micro-ecosystem. As an Algerian user of digital products from Algerian companies, I don't trust any of them, partially because of the culture in the companies, compliance with regulators. Now we're left with the following:
...
If other pieces of the privacy and data protection ecosystem are still lacking behind, or maybe undermine its importance... Can we, the developers save the show? Or at least save what we can from it?

Is it safe to say that Algerian developers care about data protection when building their production-grade software? If so, are they doing it because that their companies' polices are forcing it, or because of their ethics and training/education?
...
As developers, we like to think that we're smart just because we do things others don't understand, and think they are hard. And with that, we can be really naïve and ignorant, we can have a false confidence that may hide some of our incompetence.
...
In that finding (and many others) we found that developers test on production, we found plenty of fake accounts (the developer using his name multiple times)... That also makes us question their skills and ethics when it comes to best practices.

Let me break it to you: **A developer cannot be lazy**. There's no evidence that your favorite tech mind said it.

At this point of the article, I don't want to add another sub title of `The culture (yet again)`, and talk about the Algerian culture of being lazy, always looking to cut corners and wanna-be quick-witted aka. `قافز/شاطر`.

Some topics in the software industry are well documented, they have patterns and best practices around them, and internet is full of them, and sometimes of their checklists to make sure that everything is in place. Trusting the tools we use and ignoring these controls and cross check them should not be ethical or professional form our side.

However, many basics of programming, best practices and security might be missing in newer generations of developers. Some of the developers are AI-powered developers, or bootcamp graduates, or people who got fresh and motivated out of university with no practical work experience.

These programmers may end-up working for companies and startups, or founding their own... Therefor, if there's no mentorship from seniors and/or no will from the company to keep high standards when it comes to software safety and security, these developers may grow in their roles with some serious gaps.

But sometimes, developers and security engineers do care, and try to set high standards: They do value data privacy and security and try to respect it. However, they may face some challenges or push back from their companies.
...
This may also happen in startups, both in Algeria and abroad, where people bend some rules to move fast and hope that regulators don't catch them. In Algeria, companies feel safer on that regard.

As mentioned earlier in the article, some companies in Algeria don't care or don't even know about the law N°18–07, therefor, their developers might not be obligated to focus on this, but on their business deliverables.
...
Older generation of developers, had (and some still have) a weird philosophy of building things from scratch and a [NIH](https://en.wikipedia.org/wiki/Not_invented_here)-powered approach. Unfortunately, these developer or as they're called "L'informaticien" still exist, and still work or lead projects... 

Some people with that mentality (sometimes not even being with that old generation) do build applications from scratch, either because they think it's easier and safer to build. Or because they don't really know that sometimes frameworks and tools do the heavy-lifting and take care of some the most common security vulnerabilities.

> When I wrote the previous paragraph, I wanted to add a screenshot from one of the findings I saw in the last months and years... The finding was from a company that provides car maintenance services, where their website was poorly designed. They had a public endpoint where customers can just provide a car licensing plate to get all information about the client and the car. This is bad... 
>
...
>
> That website, was not the first one of its kind. It's not the first time we find a website built from scratch, therefor missing on some of the security practices that are usually taken care of by libraries and frameworks. It's also not the first website that omits some privacy best practices, for example: When accessing the dashboard we could see passwords in plaintext (it is wrong to store passwords unencrypted!). We could also see some weak passwords that could be easily guessed with an effortless brute-forcing.
>
> **N.B:** I called the owner of that company's website, which happened to be one of its developers and informed him about the exploits I found. I hope he doesn't sue me though :)

<br/>

On another extreme, we have the toolcoholics, the frameworkers which are often Youtube and Bootcamp graduates. These are the newer generations of developers who learned enough about programming to build websites and applications with certain technologies. The efficiency and confidence they get from their tools sometimes can be dangerous, as they start missing on certain concepts, or they may cut corners when it comes to integrating things with their framework of choice.
...
We can't fix the ecosystem as every piece of it is evolving, and the more exposed we are to technology the higher are the risks our data privacy is exposed to.

However, everyone of us can fix a piece of it, or at least: Spread awareness. Therefor, the first recommendation/idea I'd give is to just **keep talking about the topic**. Just open debates and let people ask and learn or challenge things.

Consumers, or as we named them "Users" in our model, has to be informed and taught about the risks they face when their data is mishandled, about their rights and responsibilities.

Regulators, must be firm when it comes to these topics, and fair in their judgement with everyone. They have to audit and penalize all organizations who mishandle data, whether they're private, public or even other government agencies.

They should also invest in organizations and associations to spread awareness, and to improve their websites to answer questions citizens have, and to provide easy-to-use platforms to raise concerns, and **have actionable feedback on them**!
...
And for us, the developers, we are customers so we must know our rights and other customers' rights. We must speak up and report incidents when we found them, to the right people. We either need to escalate within our companies, or report breaches to the authorities. It is a moral duty.
...
I'm Abdeldjalil, an Algerian software engineer. In my career, I dealt with GDPR-related topics. I learned from some "annoying" users to read Privacy notes in website and to demand my rights. I found vulnerabilities and data breaches in some Algerian websites, and tried to report them to their owners or to the authorities.
...
*Thank you for reaching this point of the article whether by reading, scrolling or letting your AI-friend summarize it for you. I hope we start continue talking about this topic, and help improving the Algerian tech scene*